...
const seedDatabase = async () => {
  try {
    ...
    const vehicles = await Vehicle.insertMany([
      ...
      {
        vehicleNumber: 'ML05-SIH-1002',
        type: 'mini-truck',
        capacityKg: 2800,
        status: 'available',
        currentLocation: locations.shillong,
      },
      {
        vehicleNumber: 'SK02-SIH-1003',
        type: 'container',
        capacityKg: 7000,
        status: 'available',
        currentLocation: locations.siliguri,
      },
      {
        ...
        capacityKg: 3500,
        status: 'in-transit',
        currentLocation: locations.imphal,
      },
      {
    ...
    const routes = await Route.insertMany([
      {
        ...
        destination: locations.shillong,
        waypoints: [],
        distanceKm: 99,
      ...
      {
        name: 'Siliguri to Gangtok Mountain Corridor',
        origin: locations.siliguri,
        destination: locations.gangtok,
        waypoints: [],
        distanceKm: 114,
      ...
      {
        name: 'Guwahati to Itanagar Strategic Supply Route',
        origin: locations.guwahati,
        destination: locations.itanagar,
        waypoints: [],
        distanceKm: 330,
    ...
    const shipments = await Shipment.insertMany([
      {
        trackingId: 'SIH-NE-001',
        title: 'Emergency Medical Supplies to Shillong',
        ...
        route: routes[0]._id,
        expectedDelivery: new Date(Date.now() + 18 * 60 * 60 * 1000),
      },
      {
        trackingId: 'SIH-NE-002',
        title: 'Food Relief Kits to Gangtok',
        cargoType: 'Relief food kits',
        weightKg: 2600,
        priority: 'high',
        status: 'assigned',
        driver: driver._id,
        ...
        route: routes[1]._id,
        expectedDelivery: new Date(Date.now() + 30 * 60 * 60 * 1000),
      },
      {
        trackingId: 'SIH-NE-003',
        title: 'Bridge Repair Equipment to Itanagar',
        cargoType: 'Infrastructure equipment',
        weightKg: 4200,
        priority: 'high',
        status: 'pending',
        driver: driver._id,
        ...
        route: routes[2]._id,
        expectedDelivery: new Date(Date.now() + 42 * 60 * 60 * 1000),
      },
      {
