...
const CITIES = [
  ...
  { name: 'Tawang', state: 'Arunachal Pradesh', center: [27.5860, 91.8594], zoom: 13 },
...
const FALLBACK_HAZARD_DATA = {
  ...
  tawang: [
    {
      id: 'tawang-chu-valley',
      name: 'Tawang Chu River Valley',
      hazard_type: 'flood',
      hazardType: 'flood',
      risk_level: 'High Risk: Flood Zone',
      description: 'Glacial riverbed corridor vulnerable to flash floods and sudden discharge surges.',
      coordinates: [
        [27.5920, 91.8620],
        [27.6020, 91.8730],
        [27.5970, 91.8860],
    ...
    {
      id: 'tawang-lhou-slope',
      name: 'Lhou Mudslide & Debris Corridor',
      hazard_type: 'landslide',
      hazardType: 'landslide',
      risk_level: 'High Risk: Landslide Zone',
      description: 'High gradient hill slopes with loose glacial debris prone to mass wasting.',
      coordinates: [
        [27.5620, 91.8350],
        [27.5710, 91.8440],
        [27.5660, 91.8530],
    ...
    {
      id: 'tawang-kitpi-ridge',
      name: 'Kitpi Ridge Slope',
      hazard_type: 'landslide',
      hazardType: 'landslide',
      risk_level: 'High Risk: Landslide Zone',
      description: 'Fragile mountain face along critical access roads with frequent soil slips.',
      coordinates: [
        [27.5760, 91.8480],
        [27.5840, 91.8560],
        [27.5800, 91.8660],
