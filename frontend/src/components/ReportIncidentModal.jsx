...
function ReportIncidentModal({
  ...
  return (
    <div className="fixed inset-0 z-[2000] flex items-center justify-center bg-slate-950/60 px-4 py-8 backdrop-blur-sm">
        ...
        <div className="flex items-start justify-between border-b border-slate-200 px-6 py-4">
          <div>
            ...
            <p className="mt-1 text-sm text-slate-600">
              Upload a geotagged photo and describe the emergency for rapid response.
            </p>
          </div>
